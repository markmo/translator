...
import com.telstra.daas.ai.harold.translator.translate.{FacebookTranslationActor, LiveEngageChatTranslationActor}
...
trait CoreActors {
  ...
  val facebookTranslationActor = system.actorOf(Props[FacebookTranslationActor])
  val liveEngageTranslationActor = system.actorOf(Props[LiveEngageChatTranslationActor])
